...
def test_hdate_to_hdate_pshuta_simple(year: int) -> None:
    """Transform Hebrew date to Hebrew date (single Adar)."""
    for days_in_month, months in SIMPLE_MONTHS.items():
        for month in months:
...
@pytest.mark.parametrize("year", YEARS_PSHUTA)
def test_hdate_to_hdate_pshuta_adar(year: int) -> None:
...
@pytest.mark.parametrize("year", YEARS_PSHUTA)
def test_hdate_to_hdate_pshuta_heshvan(year: int) -> None:
...
@pytest.mark.parametrize("year", YEARS_PSHUTA)
def test_hdate_to_hdate_pshuta_kislev(year: int) -> None:
...
def test_hdate_to_hdate_meuberet_simple(year: int) -> None:
...
@pytest.mark.parametrize("year", YEARS_MEUBERET)
def test_hdate_to_hdate_meuberet_adar(year: int) -> None:
...
@pytest.mark.parametrize("year", YEARS_MEUBERET)
def test_hdate_to_hdate_meuberet_heshvan(year: int) -> None:
...
@pytest.mark.parametrize("year", YEARS_MEUBERET)
def test_hdate_to_hdate_meuberet_kislev(year: int) -> None:
